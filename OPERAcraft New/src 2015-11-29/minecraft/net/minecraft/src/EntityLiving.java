...
public abstract class EntityLiving extends Entity
{
    ...
    public String getTexture()
    {
    	...
    	if (this instanceof EntityPlayer && (Vars.isProjector || Vars.isCamera || Vars.isActor) && (!Vars.playerToRoles.containsKey(this.getEntityName()) || Vars.playerToRoles.get(this.getEntityName()).equals("spectator")))
    	{
    	...
    	if (Vars.isSpectator && Vars.playerToRoles.containsKey(this.getEntityName()) && Vars.playerToRoles.get(this.getEntityName()).equals("spectator"))
    	{
    	...
    	if (Vars.playerToRoles.containsKey(this.getEntityName()))
    	{
        	...
        	{
            	//Players should see custom views of regular cameras and not see projector at all (2 skins, one for on, one for off)
        		...
        		{
        			// we make cameras invisible when spectators are observing action through cam view
