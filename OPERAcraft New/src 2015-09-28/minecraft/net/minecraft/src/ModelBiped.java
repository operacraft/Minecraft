...
public class ModelBiped extends ModelBase
{
    ...
    {    	
        ...
        if (Vars.isProjector && Vars.cameraViewPortValue != 0 && Vars.getCameraByName(par7Entity.getEntityName()) == Vars.cameraViewPortValue && Vars.commandSenderProjector != null)
        {
        	boolean found = false;
