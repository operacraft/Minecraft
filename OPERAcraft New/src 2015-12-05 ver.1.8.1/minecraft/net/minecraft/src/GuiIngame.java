   ...
   private void renderFadeBlack(int par1, int par2)
   {
    ...
    public void handleHelp()
    {
    	if (Vars.isActor && !Vars.hideActorGUI)
        {
    		...
    		{
            	font.drawStringWithShadow("§e->", 335, this.scaledWidth - 75, 16777215);
            	font.drawStringWithShadow("U - Arms Up", this.scaledWidth - 75, 10, 16777215);
            	font.drawStringWithShadow("J - Arms Down", this.scaledWidth - 75, 30, 16777215);
            	font.drawStringWithShadow("K - Left Out", this.scaledWidth - 75, 50, 16777215);
        	...
        	font.drawStringWithShadow("Y - Hide Help", this.scaledWidth - 75, this.scaledHeight - 30, 16777215);

        }
        else if (Vars.isActor && Vars.hideActorGUI)
        {
        	font.drawStringWithShadow("Y - Show Help", this.scaledWidth - 75, this.scaledHeight - 30, 16777215);   	
        }
        else if (Vars.isSpectator)
        {
        	font.drawStringWithShadow("Y - To Action", this.scaledWidth - 75, this.scaledHeight - 30, 16777215);
        	...
        	font.drawStringWithShadow( "U - " + (Vars.followProjector == 2 ? "Freeroam" : "Cam View"), this.scaledWidth - 75, this.scaledHeight - 40, 16777215);
        ...
        if (Vars.isProjector && Vars.cameraViewPortValue != 0 && Vars.commandSenderProjector != null  && Vars.viewTimeDelta < (Minecraft.getSystemTime() - 500)) // removed && Vars.getCameraByName(par7Entity.getEntityName()) == Vars.cameraViewPortValue
        {
    ...
    {
        if ((Vars.isActor || Vars.isSpectator) && !Vars.projectorView)
        {
        	font.drawStringWithShadow("H - Hide Gui", this.scaledWidth - 75, this.scaledHeight - 20, 16777215); 
        }
        else if ((Vars.isActor || Vars.isSpectator) && Vars.projectorView)
        {
        	font.drawStringWithShadow("H - Show Gui", this.scaledWidth - 75, this.scaledHeight - 20, 16777215);   	
        }
    }    
    ...
    public void handleName()
    {
    	...
    	if (Vars.playerToNickName.containsKey(playersName) && !Vars.isProjector && !Vars.isCamera && Vars.isActor)
    	{
    		if (Vars.playerToColors.containsKey(playersName))
    			font.drawStringWithShadow(Vars.colorCodes.get(Vars.playerToColors.get(playersName)) + Vars.playerToNickName.get(playersName), this.scaledWidth - 75, this.scaledHeight - 10, 16777215); 
    		else
    			font.drawStringWithShadow(Vars.playerToNickName.get(playersName), this.scaledWidth - 75, this.scaledHeight - 10, 16777215); 
    	...
    	else if (Vars.isCamera)
    	{
    		...
    		{
    			font.drawStringWithShadow("Camera - " + Vars.cameraReverseValues.get(playersName), this.scaledWidth - 75, this.scaledHeight - 10, 16777215);
    			if (Vars.currentCamera.equals(playersName))
    			{
        			font.drawStringWithShadow("  §cACTIVE", this.scaledWidth - 75, this.scaledHeight - 20, 16777215);    				
    			}
    		}
    		else
    		{
    			font.drawStringWithShadow("Camera", this.scaledWidth - 75, this.scaledHeight - 10, 16777215); 
    		}
    	}
    	else if (Vars.isSpectator || (playersName != null && !Vars.playerToRoles.containsKey(playersName)))
    	{
			font.drawStringWithShadow("Spectator", this.scaledWidth - 75, this.scaledHeight - 10, 16777215); 
    	}
    }
}
