...
public class GuiNewChat extends Gui
{
    ...
    public void printChatMessage(String par1Str)
    {
    	...
    	else
    	{
	    	...
	    	else
	    	{
    			...
    			// we exclude empty @warn and @text messages since we have already processed both of these that are not empty above
	    		//System.out.println("Short message: " + par1Str);
	    		else if (message.length > 1 && !message[1].equals("@warn") && !message[1].equals("@text"))
	    		{
	    			this.printChatMessageWithOptionalDeletion(par1Str, 0);
	    		}
	    	}
    ...
    public void printChatMessageWithOptionalDeletion(String par1Str, int par2)
    {
    	...
    	if (par1Str.startsWith("<") || par1Str.startsWith("" + EnumChatFormatting.GRAY + "" + EnumChatFormatting.ITALIC + "["))
    	{
    		return;
    	}
