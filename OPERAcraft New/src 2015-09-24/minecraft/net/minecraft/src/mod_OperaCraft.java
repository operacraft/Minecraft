...
public class mod_OperaCraft extends BaseMod {
	...
	public void load() {
		...
		Vars.teleportPath = Vars.folderPath + "\\tp_locations.txt";
		Vars.nicknamesColorPath = Vars.folderPath + "\\nicknames_colors.txt";
		...
		new OnOpenUpdate("Spectator").run(); // we use generic username here to create blocks, then update later with the real username when we get to the menu
