...
public class OnOpenUpdate {
	...
	{
		return role.toLowerCase().equals("actor") || role.toLowerCase().equals("camera") || role.toLowerCase().equals("projector") || role.toLowerCase().equals("spectator")? true : false;
	}	
