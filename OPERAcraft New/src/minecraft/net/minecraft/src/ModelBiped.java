...
public class ModelBiped extends ModelBase
{
    ...
    public ModelRenderer bipedBrows; /// TODO: where to put eyebrow in modelbiped method ?
    ...
    private void handleLegMovement(String username, float value)
    {
    	...
    	if (player != null) {
	    	if (Vars.getOperaCraftPlayerLegState(username) == 0)
	    	{
	    		player.adjustLegs(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
	    		//this.sway(value);
	    	}	
	    	
	    	//left arm out only
	    	else if (Vars.getOperaCraftPlayerLegState(username) == 1)
	    	{
	    		player.adjustLegs(-1.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
	    		//this.bipedLeftArm.rotateAngleX = -1.5F;  
	    		//this.bipedRightArm.rotateAngleZ = 0.0F;
	    		//this.bipedRightArm.rotateAngleX = 0.0F;
	    	}
	    	//right arm out only
	    	else if (Vars.getOperaCraftPlayerLegState(username) == 2)
	    	{
	    		player.adjustLegs(0.0F, 0.0F, 0.0F, -1.5F, 0.0F, 0.0F);
	    		//this.bipedRightArm.rotateAngleX = -1.5F;
	    		//this.bipedLeftArm.rotateAngleZ = 0.0F;
	    		//this.bipedLeftArm.rotateAngleX = 0.0F;
	    	}    	  
	    	//arms up
	    	else if (Vars.getOperaCraftPlayerLegState(username) == 3)
	    	{
	    		player.adjustLegs(0.0F, 0.0F, -2.7F, 0.0F, 0.0F, 2.7F);
	    		//this.bipedLeftArm.rotateAngleZ = -2.7F;
	    		//this.bipedRightArm.rotateAngleZ = 2.7F;
	    		//this.sway(value);
	    	}  
	    	//left arm angled
	    	else if (Vars.getOperaCraftPlayerLegState(username) == 4)
	    	{
	    		player.adjustLegs(-0.6F, 0.0F, -2.3F, 0.0F, 0.0F, 0.0F);
	    		/*
	    	...
	    	//right arm angled
	    	else if (Vars.getOperaCraftPlayerLegState(username) == 5)
	    	{
	    		player.adjustLegs(0.0F, 0.0F, 0.0F, -0.6F, 0.0F, 2.3F);
	    		/*
    		...
    		if (Vars.getOperaCraftPlayerLegState(username) == 0 || Vars.getOperaCraftPlayerLegState(username) > 2) {
    			this.sway(value);
    		}
    	}	
    }
