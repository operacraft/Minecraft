...
public class ModelBiped extends ModelBase
{
    ...
    {    	
        ...
        // if we are the projector and are currently latched onto one of the cameras (we use viewTimeDelta to wait for at least 250ms after the jump to minimize potential "Failed to add player" error)
        if (Vars.isProjector && Vars.cameraViewPortValue != 0 && Vars.commandSenderProjector != null  && Vars.viewTimeDelta < (Minecraft.getSystemTime() - 250)/*&& Vars.getCameraByName(par7Entity.getEntityName()) == Vars.cameraViewPortValue */)
        {
