...
public class ModelBiped extends ModelBase
{
    ...
    {    	
        ...
        if (entityRole != null && entityRole.equals("projector"))
        {
	        ...
	        if (Vars.isProjector && Vars.cameraViewPortValue != 0 && Vars.commandSenderProjector != null  && Vars.viewTimeDelta < (Minecraft.getSystemTime() - 500)/*&& Vars.getCameraByName(par7Entity.getEntityName()) == Vars.cameraViewPortValue */)
	        {
